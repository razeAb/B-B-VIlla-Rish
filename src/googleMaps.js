        ...
        <div>
            ...
            <div style={{ textAlign: "center", marginTop: "10px" }}>
                <a id="googleMapsLink" target="_blank" rel="noopener noreferrer">
                    <button style={{ padding: "10px 20px", margin: "5px", background: "#4285F4", color: "white", border: "none", borderRadius: "5px", cursor: "pointer" }}>
                        Open in Google Maps
                    </button>
                </a>
                <a id="wazeLink" target="_blank" rel="noopener noreferrer">
                    <button style={{ padding: "10px 20px", margin: "5px", background: "#00AEEF", color: "white", border: "none", borderRadius: "5px", cursor: "pointer" }}>
                        Open in Waze
                    </button>
                </a>
            </div>
